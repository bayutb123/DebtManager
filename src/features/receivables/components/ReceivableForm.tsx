...
export type ReceivableFormValues = z.infer<typeof schema>;

interface Props {
  contacts: Contact[];
  defaultValues?: Partial<ReceivableFormValues>;
  onSubmit: (values: ReceivableFormValues) => Promise<void> | void;
  loading?: boolean;
  submitLabel?: string;
}

const ReceivableForm = ({ contacts, defaultValues, onSubmit, loading, submitLabel = 'Save receivable' }: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="space-y-1">
        ...
        <Input {...form.register('title')} placeholder="Invoice to client" />
